        ...
        <CardContent className="px-4 sm:px-6">
          <form onSubmit={onSubmit}>
            <div className="flex flex-col gap-6">
              ...
              <Button 
                type="submit" 
                className="w-full text-white font-medium transition-all duration-300 bg-gradient-to-r from-[#BF00FF]/30 to-[#00FFFF]/10 hover:from-[#BF00FF]/40 hover:to-[#00FFFF]/15 h-11 sm:h-12 text-sm sm:text-base rounded-md shadow-md border-none" 
                disabled={loginIsPending}
              >
                {loginIsPending ? (
                  <>
