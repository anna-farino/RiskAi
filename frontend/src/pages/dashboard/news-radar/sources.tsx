...
// Updated the occurrences of "Auto-Scrape" to "Auto-Update", "Scrape" to "Update", and updated the button tooltips for scrape and stop actions in the sources component.