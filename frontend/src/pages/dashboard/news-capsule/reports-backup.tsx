...
export default function Reports() {
  ...
  const handleDragStart = (e: React.DragEvent, articleId: string) => {
    console.log('Starting drag for:', articleId);
  ...
  const handleDrop = (e: React.DragEvent, targetArticleId: string) => {
    ...
    console.log('Dropped:', draggedId, 'on:', targetArticleId);
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  onClick={() => {
                    // Simple Word export using HTML format
                    ...
                    let htmlContent = `
                      ...
                      <head>
                        ...
                        <style>
                          ...
                          .article { page-break-inside: avoid; margin-bottom: 36pt; border-bottom: 1px solid #ccc; padding-bottom: 18pt; }
                        </style>
                      </head>
                      <body>
