              ...
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    onClick={() => {
                      // Export to Word format with HTML formatting
                      const reportContent = `
<html>
<head>
<style>
...
<p><span class="field-label">Target OS:</span> ${article.targetOS}</p>
<p><span class="field-label">Source:</span> ${article.sourcePublication}</p>
<p><span class="field-label">Summary:</span></p>
<p>${article.summary}</p>
<p><span class="field-label">Impacts:</span></p>
<p>${article.impacts}</p>
<p><span class="field-label">Microsoft Connection:</span></p>
<p>${article.microsoftConnection}</p>
<p><span class="field-label">Original URL:</span> ${article.originalUrl}</p>
</div>
`).join('')}

<div style="text-align: center; margin-top: 24pt;">
<p>Report Generated by RisqAI News Capsule</p>
</div>
</body>
</html>
`;
                      ...
                      link.href = url;
                      link.download = `Executive_Report_${formatDate(selectedReport.createdAt).replace(/,|\s/g, '_')}${selectedReport.versionNumber && selectedReport.versionNumber > 1 ? `_v${selectedReport.versionNumber}` : ''}.doc`;
