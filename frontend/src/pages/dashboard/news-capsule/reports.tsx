...
<p style="text-align:center; margin-top:36pt; font-style:italic;">Report Generated by RisqAI News Capsule</p>
                      ...
                      // Force download with proper Word format
                      ...
                      a.href = url;
                      a.download = `Executive_Report_${formatDate(selectedReport.createdAt).replace(/[^a-z0-9]/gi, '_')}${selectedReport.versionNumber && selectedReport.versionNumber > 1 ? `_v${selectedReport.versionNumber}` : ''}.doc`;
