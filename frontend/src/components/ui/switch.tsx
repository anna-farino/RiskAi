...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "flex pointer-events-none h-5 min-w-5 rounded-full bg-white shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-[3px] data-[state=unchecked]:-translate-x-[15px]"
      )}
    />
  </SwitchPrimitives.Root>
))
