...
- **Global Scraping Infrastructure** (Updated 2025-08-18): Transformed from per-user to global scraping system. All sources are scraped every 3 hours globally, with articles saved to a shared pool. Users apply query-time filtering to see relevant content.
...
- **Platform-wide Visual Consistency**: Comprehensive design system unification with standardized `rounded-md` (0.375rem / 6px) corner radius across all platform components including News Radar, Threat Tracker, News Capsule, Settings, Dashboard, Login flows, widgets, navigation, and utility components. Semantic `rounded-full` preserved for status indicators, badges, and circular elements. **Updated January 2025**: Standardized all borders to consistent /30 weights with solid black backgrounds, replacing all custom brand-colored hex values (#BF00FF, #00FFFF, #FF00BF) with standard Tailwind classes (cyan-400, purple-400, etc.) for clean, professional appearance across all three dashboard cards.
...
- **Smart Relevance Filtering**: Replaced basic content type filters with AI-driven relevance scoring system that categorizes articles into High Priority (80-100), Medium Priority (50-79), and Low Priority (1-49) based on keyword match quality and context analysis. Updated January 2025.
- **Executive Report Dashboard**: Transformed News Capsule home page from individual article display to executive report summary tiles in 3-column responsive layout. Features AI-driven threat level assessment, report-specific filtering, and seamless navigation to detailed Reports page. Updated January 2025.
- **Unified Research Toolbar**: Implemented collapsible unified toolbar for News Capsule Research page with organized sections for URL Processing (single/bulk mode toggle), Report Actions (topic input and executive report buttons), and Article Management (status indicators). Features consistent orange theme branding, rounded-md styling, and streamlined workflow integration. Updated January 2025.
...
### Phase 1: Data Migration (Completed 2025-08-18)
...
- **2.4 Enhanced Anti-Bot Protection** (Completed 2025-08-18): Dynamic scraper resilience
...
### Phase 3: Unified Global Scraping System (Completed 2025-08-20)
...
### Phase 4: Unified Global Strategy (Completed 2025-08-20)
...
### Phase 5: Critical Bug Fixes (Completed 2025-08-21)
...
### Phase 6: Enhanced Bot Detection Bypass (Completed 2025-08-21)
