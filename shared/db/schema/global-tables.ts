...
// Global Sources validation schemas
export const insertGlobalSourceSchema = createInsertSchema(globalSources, {
...
export const updateGlobalSourceSchema = createInsertSchema(globalSources, {
